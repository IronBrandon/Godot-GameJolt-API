...
Read [LICENSE](addons/gamejolt-api/LICENSE) \
Download from [Godot Asset Library](https://godotengine.org/asset-library/asset/3364)
...
1. You start by installing 'gamejolt_api' from:
    - the [Godot Asset Library](https://godotengine.org/asset-library/asset/3364) in the editor,
...
4. Next, go to _Project > Project Settings... > Plugins_ and enable the "GameJolt API" plugin.
5. You can also go to 'gamejolt\.gd', add a line, save, then remove it and save again.
